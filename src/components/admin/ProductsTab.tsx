...
function ProductsTab({ token }: ProductsTabProps) {
  ...
  const handleImageUpload = (files: FileList) => {
    const newFiles = Array.from(files).slice(0, 6 - uploadedImages.length);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('category', selectedProductType || selectedSubCategory);
  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-start">
        <div>
          <h2 className="font-serif text-2xl text-charcoal-800 text-distressed">Add New Product</h2>
          <p className="font-sans-clean text-charcoal-600 mt-1">
            Create a new original item for your collection
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            />
            {errors.productName && (
              <p className="text-red-600 text-sm mt-1 font-sans-clean">{errors.productName}</p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-3 top-1/2 transform -translate-y-1/2 font-sans-clean text-charcoal-600">$</span>
              <input
                type="number"
                step="0.01"
                value={productPrice}
            ...
            {errors.productPrice && (
              <p className="text-red-600 text-sm mt-1 font-sans-clean">{errors.productPrice}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="featured" className="ml-2 font-serif text-xl text-charcoal-800 text-distressed">
              Featured Product
            </label>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-oatmeal-400 bg-oatmeal-50 focus:border-oatmeal-600 focus:bg-oatmeal-25 focus:outline-none transition-colors font-sans-clean disabled:opacity-50 disabled:cursor-not-allowed"
            >
